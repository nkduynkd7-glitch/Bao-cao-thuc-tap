...
#### 5. Thêm đĩa Cloud-init:

- Trong phần Hardware của quá trình tạo máy ảo, bạn cần thêm một Cloud-init Disk để cấu hình các tham số như user, password, SSH key, IP, v.v.

- Chọn Add -> Cloud-init.

- Cloud-init sẽ tạo một đĩa đặc biệt, giúp Proxmox đọc các cấu hình khi máy ảo khởi động.
...
#### Regenerate Cloud-init Disk:

- Sau khi cấu hình xong, bạn bấm vào Regenerate để Proxmox tạo lại Cloud-init disk với cấu hình mà bạn đã thay đổi.
